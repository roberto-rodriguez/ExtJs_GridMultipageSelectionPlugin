...
Ext.define('Ext.ux.grid.GridMultipageSelection', {
    ...
    change: function () {
        ...
        if (me['multipageSelection'] && me['multipageSelection'][me.store.currentPage]) {
            ...
            me.store.data.each(function (element, i) {
                if (me['multipageSelection'][me.store.currentPage].indexOf(element.raw.id) >= 0) {
    ...
    selectionchange: function (view, selectedRecords, opts) {
        ...
        Ext.each(selectedRecords, function (record) {
            multipageSelection[grid.store.currentPage].push(record.raw.id);
        }, this);
